...
interface InstitutionTableProps {
  ...
  onViewFaculties: (institution: Institution) => void;
        ...
        <table className="divide-y divide-gray-200 dark:divide-gray-700 min-w-full">
          ...
          <tbody className="bg-white dark:bg-transparent divide-y divide-gray-200 dark:divide-gray-700">
            {institutions.map((institution) => (
              <tr key={institution.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                ...
                <td className="px-6 py-4 text-sm text-right whitespace-nowrap">
                  <div className="flex justify-end gap-2">
                    <button
                      onClick={() => onViewFaculties(institution)}
