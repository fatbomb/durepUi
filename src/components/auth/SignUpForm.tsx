...
export default function SignUpForm() {
  ...
  return (
    <div className="flex flex-col flex-1 w-full lg:w-1/2 overflow-y-auto no-scrollbar">
      {/* <div className="mx-auto mb-5 sm:pt-10 w-full max-w-md">
        <Link
          to="/"
      ...
      <div className="flex flex-col flex-1 justify-center mx-auto w-full max-w-md">
        <div>
          ...
          <div>
            {/* <div className="gap-3 sm:gap-5 grid grid-cols-1 sm:grid-cols-2">
              <button className="inline-flex justify-center items-center gap-3 bg-gray-100 hover:bg-gray-200 dark:bg-white/5 dark:hover:bg-white/10 px-7 py-3 rounded-lg font-normal text-gray-700 hover:text-gray-800 dark:text-white/90 text-sm transition-colors">
                <svg
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
