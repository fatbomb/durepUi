...
interface AllFacultiesTableProps {
  faculties: Faculty[];
  loading: boolean;
...
export default function AllFacultiesTable({
  faculties,
  loading,
  onEdit,
  onDelete,
  isSuperAdmin,
}: AllFacultiesTableProps) {
              ...
              <tr key={faculty.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                ...
                <td className="px-6 py-4 text-sm text-right whitespace-nowrap">
                  <div className="flex justify-end gap-2">
                    <button
                      onClick={() => navigate(`/institutions/${faculty.institution_id}/departments`)}
